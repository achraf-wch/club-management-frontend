...
const WhyChooseUs = () => {
  ...
  return (
    ...
    >
      ...
      {/* Decorative Lines */}
      <div className="absolute top-0 left-0 w-full h-1 bg-gradient-to-r from-transparent via-[#54ACBF] to-transparent opacity-50"></div>
      <div className="absolute bottom-0 left-0 w-full h-1 bg-gradient-to-r from-transparent via-[#54ACBF] to-transparent opacity-50"></div>
      ...
      <div className="max-w-7xl mx-auto relative z-10">
        ...
        <div className="text-center mb-16">
          ...
          <p className={`text-lg mx-auto max-w-2xl transition-all duration-1000 delay-200 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`} style={{ color: '#A7EBF2' }}>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 lg:gap-12">
          {features.map((feature, index) => (
            ...
            >
              {/* Card Container */}
              <div className="relative h-full p-8 rounded-2xl backdrop-blur-sm border border-white/10 bg-white/5 hover:bg-white/10 transition-all duration-500 hover:shadow-2xl hover:-translate-y-2 overflow-hidden">
                ...
                <div className="relative z-10 text-center">
                  ...
                  {/* Title */}
                  <h3 className="text-white text-xl font-bold mb-4 group-hover:text-[#A7EBF2] transition-colors duration-300">
                    {feature.title}
                  </h3>
                  
                  {/* Description */}
                  <p className="text-sm leading-relaxed mb-5" style={{ color: '#A7EBF2' }}>
                    {feature.description}
                  </p>
          ...
          {[
            ...
            >
              ...
              <div className="relative z-10">
                ...
                <div className="text-xs font-medium" style={{ color: '#A7EBF2' }}>
                  {stat.label}
                </div>
              </div>

              {/* Rotating Ring on Hover */}
              <div className="absolute inset-0 rounded-full border-2 border-dashed opacity-0 group-hover:opacity-30 group-hover:animate-spin transition-opacity duration-500" style={{ borderColor: '#54ACBF', animationDuration: '8s' }}></div>
            </div>
          ))}
        </div>
      </div>
