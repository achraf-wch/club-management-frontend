...
const AdminSidebar = () => {
  ...
  const menuItems = [
    ...
    {
      name: 'Supprimer un Club',
      path: '/admin/delete-club',
      icon: (
        <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
  ...
  return (
    <div className={`w-64 min-h-screen flex flex-col ${dm ? 'bg-gray-900 text-white' : 'bg-white text-gray-900'}`}>
      ...
      <nav className="flex-1 p-4 space-y-2">
        ...
        <Link
          to="/"
          className="flex items-center gap-3 px-4 py-3 rounded-lg bg-emerald-600 hover:bg-emerald-700 transition-colors"
        >
          <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 12l2-2m0 0l7-7 7 7M5 10v10a1 1 0 001 1h3m10-11l2 2m-2-2v10a1 1 0 01-1 1h-3m-6 0a1 1 0 001-1v-4a1 1 0 011-1h2a1 1 0 011 1v4a1 1 0 001 1m-6 0h6" />
          </svg>
