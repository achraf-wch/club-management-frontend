...
const BoardDashboard = () => {
  ...
  // ── Real counts (same approach as AdminDashboard) ─────────────────────────
  ...
  const fetchDashboardData = async () => {
    try {
      // ── 1. Club info via my-club-info (same as ClubManagement) ────────────
              ...
              {[
                {
                  ...
                  title: "Nouvelle demande d'adhésion", sub: 'Ahmed Benali', time: '2h',
                ...
                },
                {
                  ...
                  title: 'Événement créé', sub: 'Workshop React.js', time: '5h',
                ...
                },
                {
                  ...
                  title: 'Membre approuvé', sub: 'Sara Alami', time: '1j',
              ...
              {[
                {
                  ...
                  title: 'Action Rapide', desc: 'Vérifiez régulièrement les demandes en attente'
                },
                {
                  bg: dm ? 'bg-blue-500/10' : 'bg-blue-100',
                  ...
                  title: 'Organisation', desc: 'Planifiez des événements réguliers'
                },
                {
                  ...
                  title: 'Communication', desc: 'Gardez les membres informés'
                },
              ].map((tip, idx) => (
