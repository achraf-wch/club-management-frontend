...
const PresidentMembersList = () => {
  ...
  const getRoleBadge = (role) => {
    const styles = {
      president: 'bg-red-500/20 text-red-300 border-red-500/30',
      board: 'bg-white/20 text-white/70 border-white/30',
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <div>
              ...
              <input
                ...
                className="w-full px-4 py-2 bg-white/5 border border-white/10 rounded-xl text-white placeholder-white/40 focus:ring-2 focus:ring-red-500 focus:border-transparent"
              />
            </div>
            ...
            <div>
              ...
              <select
                ...
                className="w-full px-4 py-2 bg-white/5 border border-white/10 rounded-xl text-white focus:ring-2 focus:ring-red-500 focus:border-transparent"
              >
                <option value="all" className="bg-gray-800">Tous</option>
                <option value="active" className="bg-gray-800">Actifs</option>
                <option value="inactive" className="bg-gray-800">Inactifs</option>
              </select>
            </div>
          </div>
        </div>
        ...
        {club && members.length > 0 && (
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-6">
            <div className="bg-gradient-to-br from-red-500/20 to-red-600/20 backdrop-blur-lg rounded-xl border border-red-500/30 p-6">
              <div className="flex items-center justify-between">
                <div>
                  <p className="text-red-300 text-sm font-semibold">Total Membres</p>
            ...
            <div className="bg-gradient-to-br from-white/20 to-gray-500/20 backdrop-blur-lg rounded-xl border border-white/30 p-6">
              <div className="flex items-center justify-between">
                <div>
                  <p className="text-white/70 text-sm font-semibold">Bureau</p>
                  <p className="text-3xl font-bold text-white mt-1">
        ...
        {loading ? (
          ...
          <div className="bg-white/5 backdrop-blur-lg rounded-xl border border-white/10 p-12 text-center">
            ...
            <button
              ...
              className="bg-gradient-to-r from-red-600 to-red-700 hover:from-red-700 hover:to-red-800 text-white py-3 px-6 rounded-xl font-semibold transition-all shadow-lg"
            >
              Ajouter un membre
            </button>
          </div>
                ...
                <div className="space-y-6">
                  ...
                  <div>
                    ...
                    <select
                      ...
                      className="w-full px-4 py-2 bg-white/5 border border-white/10 rounded-xl text-white focus:ring-2 focus:ring-red-500 focus:border-transparent"
                    >
                      <option value="member" className="bg-gray-800">Membre</option>
                      <option value="board" className="bg-gray-800">Bureau</option>
                      {user?.clubRole === 'president' && (
                        <option value="president" className="bg-gray-800">Président</option>
                      )}
                    </select>
                  </div>
                ...
                <div className="mt-8 flex gap-4">
                  ...
                  {selectedMember.role !== 'president' && (
                    <button
                      ...
                      disabled={actionLoading}
                      className="flex-1 bg-gradient-to-r from-gray-600 to-gray-700 hover:from-gray-700 hover:to-gray-800 text-white py-3 px-6 rounded-xl font-semibold transition-all disabled:opacity-50 shadow-lg"
                    >
